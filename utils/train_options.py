...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--batch_size', type=int, default=224, help='Batch size')                                                                                                                  ############
        ...
        train.add_argument('--train_dataset', default=None, help='which dataset to be trained on, if none, use full dataset')
        ...
        train.add_argument('--bbox_type', default='square', help='Use square bounding boxes in 224x224 or rectangle ones in 256x192')
        train.add_argument('--wo_enc', default=False, action="store_true", help='Not using relative encodings')
        train.add_argument('--wo_fuse', default=False, action="store_true", help='Not using fusion module')
        train.add_argument('--encoder', default='resnet50', help='Backbone for extracting raw features')

        train.add_argument('--n_views', type=int, default=5, help='Views to use')  
        train.add_argument('--use_gcn', default=False, action='store_true', help='Use GCN for the second-stage feature integration')
        ...
        train.add_argument('--use_con', default=False, action='store_true', help='Use contrastive loss to scatter latent features')
        train.add_argument('--use_parallel', default=False, action='store_true', help='Use parallel stages for regression')

        train.add_argument('--use_msa', default=False, action='store_true', help='Use sel attention head for feature fusion')
        train.add_argument('--use_extraviews', default=False, action='store_true', help='Use parallel stages for regression')
        train.add_argument('--rescale_bbx', default=False, action='store_true', help='Use rescaled bbox for consistency data aug and loss')
        train.add_argument('--shift_center', default=False, action='store_true', help='Use shifted center for consistency data aug and loss')
        
        train.add_argument('--use_matrix', default=False, action='store_true', help='Use matrix for regression')
        train.add_argument('--acc_loss', default=False, action='store_true', help='calcualate avg loss')
        train.add_argument('--test_time', default=False, action='store_true', help='Disble gradients')
        train.add_argument('--att_num', type=int, default=25, help='Number of attention feature') 
        train.add_argument('--category_num', type=int, default=8, help='Number of different training dataset categories') 
        ...
        train.add_argument('--shape_loss_weight', default=1.0, type=float, help='Weight of per-vertex loss') 
        ...
        train.add_argument('--cam_loss_weight', type=float, default=1., help='Weight for loss cam-consistency during training')
        train.add_argument('--con_loss_weight', type=float, default=0.1, help='Weight for loss_contrast during training')
        ...
        train.add_argument('--ALB', default=False, action='store_true', help='Use albumentation augmentation for datasets')
        train.add_argument('--rand', default=False, action='store_true', help='Use random augs')
        train.add_argument('--large_bbx', default=False, action='store_true', help='Use large bounding boxes')
        train.add_argument('--multi_bbox', default=False, action='store_true', help='Use multiple bounding boxes for augmentation')
        train.add_argument('--multilevel_crop_rand_prob', default=0.3, type=int, dest='multilevel_crop_rand_prob', help='probability to apply random body cropping.')
        train.add_argument('--model_name', default='hmr', type=str, help='Use large bouding boxes')

        train.add_argument('--sum', default=False, action='store_true', help='Summary saving frequency') 
        train.add_argument('--summary_steps', type=int, default=1000, help='Summary saving frequency')                                                                                                     ############
        train.add_argument('--test_steps', type=int, default=1500, help='Testing frequency during training')                                                                                                     ############
        train.add_argument('--checkpoint_steps', type=int, default=100, help='Checkpoint saving frequency')
        train.add_argument('--test_epochs', type=int, default=1, help='Testing frequency(by epoch)')
